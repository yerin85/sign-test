...
public class GraphicSignature {
	...
	/**
	 * Set origin coordinate of signature's image. The coordinate starts (0,0) at
	...
	/**
	 * Insert signature's image into PDF. Resizing signature's image to fit
	 * signatureWidth area on x,y coordinate.
	 *
